...
<body>
    ...
    <div class="section">
        <div class="container">
            <div class="judul"><h3>Edit Data Produk</h3></div>
            <div class="box">
               <form action="" method="POST" enctype="multipart/form-data">
                   ...
                   <input type="text" name="harga" class="input-control" placeholder="Harga Barang" value="<?php echo $p->product_price ?>" required>
